        ...
        <form class="w-full max-w-lg" method="POST" action="/store">
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
                ...
                <div class="px-4 pb-5 bg-gray-50 text-right sm:px-6">
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" name="create-task" type="submit">
                        Create
                    </button>
